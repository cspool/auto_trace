...
The original migration recorded the following workflow identity. It is
historical provenance, not the hash of the current maintained Workflow/skill;
the active runtime manifest pins the current skill tree:
