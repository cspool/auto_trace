...
for name in ['native_PMC_independent_overlap_probe_020','native_PMC_independent_dual_context_probe_021','native_PMC_mp_transport_marker_probe_023','native_PMC_supervised_transport_probe_024']:
    ...
    probes.append(rec(p))
union_gate=B/'native_session_union_CPU_gate_001/RESULT.json';assert json.loads(union_gate.read_text())['status']=='complete_CPU_gate'
...
fixture=B/'independent_worker_collectors_CPU_fixture_002';fixture.mkdir();calls=[]
