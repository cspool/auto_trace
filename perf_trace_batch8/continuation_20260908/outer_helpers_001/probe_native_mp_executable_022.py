...
B = R / 'raw/runtime_tools/native_PMC_mp_executable_probe_022'
...
def main():
    ...
    try:
        ...
        for rank, process in enumerate(processes):
            ...
            results.append({'rank': rank, 'counts': dict(counts), 'pipe_result': pipe_results[rank], 'native_csv': source_record(unit / 'capture.csv'), 'native_db': source_record(unit / 'capture.db')})
