...
CONTROL=Path('/public/home/accl15ptg7/run_R08_R10');RUN=Path('/public/home/accl15ptg7/auto_trace/perf_trace_batch8/runtime/workflow01-10-fresh-e2e/batch8-dp2-fresh-003');DEADLINE=datetime.datetime.fromisoformat('2026-09-08T20:18:09+00:00').timestamp();PY=sys.executable
...
def main():
 ...
 run([PY,'-B',str(CONTROL/'prepare_stage_assignments_001.py'),'assign','R08']);phase(r08,'resource_model',r08/'tools/analysis_006/build_resource_model.py');phase(r08,'resource_audit',r08/'tools/analysis_006/audit_resource_model.py');phase(r08,'seal',r08/'tools/closure_001/seal_r08.py');phase(r08,'completion_audit',r08/'tools/closure_001/audit_r08.py');run([PY,'-B',str(CONTROL/'prepare_stage_assignments_001.py'),'handoff','R08'])
