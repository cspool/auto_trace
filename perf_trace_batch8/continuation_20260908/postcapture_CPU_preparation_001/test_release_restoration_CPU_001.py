...
m.save(C/'RELEASE_RESTORATION_CPU_GATE.json',{'status':'complete','production_restore_source':m.rec(C/'restore_all_R08_release_artifacts_001.py'),'exact_binary_member_roundtrip':True,'canonical_symlink_binding':True,'completed_restart_idempotent':True,'wrong_SHA256_rejected':True,'native_device_calls':0,'network_calls':0,'actual_weights_removed':False,'actual_R08_capture_files_restored':False});print('RELEASE_RESTORATION_CPU_GATE_COMPLETE')
