...
- 2026-09-08T18:16:42.461536+00:00: Capture09 attempt006 raw capture completed in 2,496.742 seconds, including normal collector export and full lossless union audit of all 30,645,909 native rows plus original CSV body bytes. Both original DB/CSV sessions are retained and SHA-bound in the execution manifest and raw inventory. Scheduler013 began analysis008 normalization at 18:15:26 UTC. Native attribution and capture acceptance remain pending.

- 2026-09-08T18:20:26.514488+00:00: 09_chunk_gated_delta_rule_fwd_kernel_h_blockdim64_pmc_write attempt_006 accepted after closed native attribution and independent audit; 384 exact dispatches, ranks {"0": 192, "1": 192}, 71424 counter values independently recomputed. Raw Release publication/offload status is tracked separately.

- 2026-09-08T18:24:28.860340+00:00: 09_chunk_gated_delta_rule_fwd_kernel_h_blockdim64_pmc_write Release published with server asset size/SHA256 verified: https://github.com/cspool/auto_trace/releases/tag/perf-trace-batch8-r08-09-chunk-gated-delta-rule-fwd-kernel-h-blockdim64-pmc-write-20260908. Authorized local large-file eviction completed for 8011147487 bytes. Original member manifests and restoration receipts retained on NFS and checkpointed here.

- 2026-09-08T18:25:34.146080+00:00: Capture10 chunk_fwd_kernel_o pmc attempt001 started at 18:24:15 UTC under scheduler013/runtime021/analysis008 after capture09 was independently accepted, fully published with current server asset SHA verification, and its five large files were safely offloaded. Weights remain physically under /root and all new capture outputs remain on NFS. No capture10 completion or coverage is claimed at startup.

- 2026-09-08T18:33:32.887897+00:00: 10_chunk_fwd_kernel_o_pmc attempt_001 passed both-device native prehealth and released the original four requests per rank in exact observed R07 admission order. Warmup native reset recorded on ranks []. Complete live marker and closed native attribution audits are still required.

- 2026-09-08T18:37:25.559455+00:00: Capture 10 attempt_001 passed exact live coverage for all eight requests, each with 784 declared first-prefill and 784 first-decode targets, 12,544 total, no missing or duplicate targets. Both rank orders match R07. Original live-prefix hashes and checker code are retained. Closed native attribution and capture acceptance remain pending.
...
- 2026-09-08T18:59:53.315454+00:00: Capture 10 attempt_001 produced a lossless derived union of 29553060 original native rows and 29741 original CSV data lines. Both original DB/CSV identities exactly match the earlier independently hashed closed-source receipt. The derived DB SHA also matches the bounded read-only sequential pass. Full independent cell and native attribution audits remain required; this is not capture acceptance.

- 2026-09-08T19:02:41.756129+00:00: Capture 10 attempt_001 sealed raw capture in 2238.271 seconds. Lossless union audit compared all 29553060 original native rows and all original CSV body bytes. Execution identities match the earlier closed native source seal. All collectors are closed; native attribution and independent acceptance remain separate pending steps.

- 2026-09-08T19:05:54.237240+00:00: 10_chunk_fwd_kernel_o_pmc attempt_001 accepted after closed native attribution and independent audit; 384 exact dispatches, ranks {"0": 192, "1": 192}, 71424 counter values independently recomputed. Raw Release publication/offload status is tracked separately.

- 2026-09-08T19:09:19.268430+00:00: Actual read-only Release/CDN range smoke passed using the prepared restorer routes: first 64 KiB, resumed 64 KiB, and last 64 KiB of a published 950 MB asset returned exact HTTP206 ranges and lengths. No signed URLs or proxy configuration were persisted. This checks live resume transport only; full asset and original-member SHA checks still occur during restoration after all12 accepted captures. No weights were changed and no restoration began.

- 2026-09-08T19:09:40.498097+00:00: 10_chunk_fwd_kernel_o_pmc Release published with server asset size/SHA256 verified: https://github.com/cspool/auto_trace/releases/tag/perf-trace-batch8-r08-10-chunk-fwd-kernel-o-pmc-20260908. Authorized local large-file eviction completed for 7731988998 bytes. Original member manifests and restoration receipts retained on NFS and checkpointed here.

- 2026-09-08T19:11:14.536285+00:00: Capture 11 attempt_001 started under frozen runtime021/analysis008 with model weights at /root/Qwen3.5-27B and new outputs on NFS. Immutable startup controls are preserved. Startup does not establish warmup health, eight-request trace coverage, or capture acceptance.
...
- 2026-09-08T19:33:35.808690+00:00: Capture 11 attempt_001 completed both independent native collectors normally, return code 0, no signals, no timeout or forced group cleanup. All eight original requests completed. Original DB/CSV and collector logs remain on NFS. Lossless union verification and independent native attribution remain pending.

- 2026-09-08T19:33:39.423879+00:00: Capture 11 attempt_001 has both original closed native DB/CSV files independently SHA-256 sealed before derived union completion. The receipt binds normal collector closure and the frozen capture contract. It supports source identity verification if the container is lost during CPU analysis; it does not claim capture acceptance.

- 2026-09-08T19:44:55.615862+00:00: Capture 11 attempt_001 produced a lossless derived union of 29550732 original native rows and 29639 original CSV data lines. Both original DB/CSV identities exactly match the earlier independently hashed closed-source receipt. The derived DB SHA also matches the bounded read-only sequential pass. Full independent cell and native attribution audits remain required; this is not capture acceptance.
...
- 2026-09-08T20:08:51.012141+00:00: Capture 12 attempt_001 passed exact live coverage for all eight requests, each with 784 declared first-prefill and 784 first-decode targets, 12,544 total, no missing or duplicate targets. Both rank orders match R07. Original live-prefix hashes and checker code are retained. Closed native attribution and capture acceptance remain pending.

2026-09-08T20:17:16.283804Z: Capture 12 attempt_001 completed all eight original measured requests, HTTP 200 and 1024 tokens each, total 8192, zero failed requests; both native rank stop events are retained. Measured replay duration 808.111 seconds is diagnostic only, not R07 observed latency. Native export and independent attribution are still required.

- 2026-09-08T20:19:11.383238+00:00: Capture 12 attempt_001 completed both independent native collectors normally, return code 0, no signals, no timeout or forced group cleanup. All eight original requests completed. Original DB/CSV and collector logs remain on NFS. Lossless union verification and independent native attribution remain pending.

- 2026-09-08T20:19:14.891940+00:00: Capture 12 attempt_001 has both original closed native DB/CSV files independently SHA-256 sealed before derived union completion. The receipt binds normal collector closure and the frozen capture contract. It supports source identity verification if the container is lost during CPU analysis; it does not claim capture acceptance.

- 2026-09-08T20:30:27.634560+00:00: Capture 12 attempt_001 produced a lossless derived union of 29540791 original native rows and 29566 original CSV data lines. Both original DB/CSV identities exactly match the earlier independently hashed closed-source receipt. The derived DB SHA also matches the bounded read-only sequential pass. Full independent cell and native attribution audits remain required; this is not capture acceptance.

- 2026-09-08T20:33:25.389757+00:00: Capture 12 attempt_001 sealed raw capture in 2233.76 seconds. Lossless union audit compared all 29540791 original native rows and all original CSV body bytes. Execution identities match the earlier closed native source seal. All collectors are closed; native attribution and independent acceptance remain separate pending steps.

- 2026-09-08T20:36:29.420281+00:00: 12_chunk_fwd_kernel_o_pmc_write attempt_001 accepted after closed native attribution and independent audit; 384 exact dispatches, ranks {"0": 192, "1": 192}, 71424 counter values independently recomputed. Raw Release publication/offload status is tracked separately.

- 2026-09-08T20:36:29.509048+00:00: All 12 R08 capture groups accepted; all 36 execution/normalization/independent-audit records match their SHA256 identities, both ranks are represented in every group, and 6,912 physical dispatches are attributed. This completes GPU capture collection; R08 stage completion still requires restored originals, resource construction and closure audits, followed by R09 and R10.
...
- 2026-09-08T20:50:29.815782+00:00: Restoration checkpoint groups_03: root weights were removed only after all 12 GPU captures and publications closed; 3/12 capture groups have original-SHA restoration receipts (13251173857 bytes). Stage completion is tracked separately.

- 2026-09-08T20:58:25.375756+00:00: Restoration checkpoint groups_06: root weights were removed only after all 12 GPU captures and publications closed; 6/12 capture groups have original-SHA restoration receipts (36969651806 bytes). Stage completion is tracked separately.

- 2026-09-08T21:06:18.457200+00:00: Restoration checkpoint groups_09: root weights were removed only after all 12 GPU captures and publications closed; 9/12 capture groups have original-SHA restoration receipts (53806597962 bytes). Stage completion is tracked separately.

- 2026-09-08T21:17:46.956405+00:00: Restoration checkpoint groups_12: root weights were removed only after all 12 GPU captures and publications closed; 12/12 capture groups have original-SHA restoration receipts (77001580022 bytes). Stage completion is tracked separately.

- 2026-09-08T21:19:38.883028+00:00: Restoration checkpoint complete: root weights were removed only after all 12 GPU captures and publications closed; 12/12 capture groups have original-SHA restoration receipts (77001580022 bytes). Stage completion is tracked separately.

- 2026-09-08T21:29:02.746148+00:00: Actual CPU prefix admission exposed repeated rebuilding of 67 authorized file-path mappings for every source. A new outer-only validator preserves live checks for every distinct directory binding, used file binding, final resolved path and every source SHA256. 233 real paths (including all 53 restored originals) match the original validator; 11 adversarial fixtures also match. Path validation measured 6.221 s before and 0.125 s after (49.6x); no frozen business or capture code changed. A new outer resume revision reuses the exact frozen R08 tools and rechecks all restored original hashes before admission. Activation follows separately.

- 2026-09-08T21:30:42.149939+00:00: Validated outer CPU path optimization activated. Old admission PID 1146630 and its outer parent chain closed before any business phase; original frozen R08 closure tools reused byte-for-byte. New outer CPU003 session 61412 first rehashes all 53 restored originals, then executes complete optimized prefix checks and the unchanged R08/R09/R10 business tools.
...
- 2026-09-08T21:58:15.391844+00:00: R08 actual completion audit and full handoff are COMPLETE (sealed 2026-09-08T21:55:58.388956+00:00). All 12 captures cover all 8 requests with trace and selected PMC; both ranks each contain four requests, 6,912 physical attributes are conserved, and all 26 original raw inventories (including failed attempts) were verified. All four CPU phases closed normally. R08 full stage Release preparation and R09 predecessor admission have started. R09/R10 completion and final remote publications remain required.

- 2026-09-08T22:04:01.121193+00:00: R09 actual CPU admission complete; 157967 full predecessor file records rehashed (176210518560 logical bytes), including complete R08. Actual analysis table construction started under the closed CPU phase runner. R09/R10 completion remains pending.

- 2026-09-08T22:10:13.667838+00:00: R09 actual table audit, completion audit and full handoff COMPLETE. All 12 tables validated, including all 8 requests, 12,544 processes, 23,660 strict owned kernels, 316,802 runtime-context rows, 2,491,806 utilization samples, 2 clock anchors, 800 gaps, 59,864 dependency nodes and 32,492 edges. Per-request first prefill/decode target counts are each 784. All four CPU phases closed normally. R10 predecessor admission started; final reports and all full-stage Release verifications remain pending.

- 2026-09-08T22:12:32.639639+00:00: Complete R08 package content verified: 1,831 newly packaged members, 31,108,531,285 bytes, plus exact references to 670 already published accepted raw files. Seven compressed archive parts total 5,909,506,836 bytes. All part and member identities are checkpointed before full upload completion. Final server asset verification remains pending.

- 2026-09-08T22:15:20.897488+00:00: R10 actual CPU admission complete; 157995 predecessor file records rehashed (178926644115 logical bytes), including complete audited R08 and R09. Actual offline report rendering started; acceptance payload and all new output/log paths remain physical NFS. Real browser acceptance, final stage audit, handoff and publications remain required.

- 2026-09-08T22:17:50.631382+00:00: R08 complete stage Release published: https://github.com/cspool/auto_trace/releases/tag/perf-trace-batch8-r08-complete-20260908. All 10 exact expected asset sizes and server SHA256 digests match the verified package manifests. Upload caches were removed after verification; original stage data and logs remain under their authorized storage paths.

- 2026-09-08T22:18:33.749641+00:00: R09 complete stage Release published: https://github.com/cspool/auto_trace/releases/tag/perf-trace-batch8-r09-complete-20260908. All 4 exact expected asset sizes and server SHA256 digests match the verified package manifests. Upload caches were removed after verification; original stage data and logs remain under their authorized storage paths.

- 2026-09-08T22:21:04.020268+00:00: Actual R10 rendering completed normally in 252.361 seconds. Full Perfetto timeline has exactly 59,872 events, with no sampling or Top-N/event cap; five self-contained pages generated. Full render and timeline manifests checkpointed. Actual offline browser acceptance is running and remains required before stage completion.

- 2026-09-08T22:25:27.047529+00:00: All five actual R10 offline pages passed real Chromium acceptance. Browser verified all 378,722 timeline/context records (59,872 main), complete coverage of all 8 requests, 105 exact back/forward states at a 1 ns span, full interval results with no cap, and zero attempted external network requests. All browser processes closed normally. Screenshots, actual browser proof and offline acceptance manifest checkpointed; independent report completion audit remains pending.

- 2026-09-08T22:34:02.253200+00:00: R10 complete stage Release published: https://github.com/cspool/auto_trace/releases/tag/perf-trace-batch8-r10-complete-20260908. All 5 exact expected asset sizes and server SHA256 digests match the verified package manifests. Upload caches were removed after verification; original stage data and logs remain under their authorized storage paths.

- 2026-09-08T22:34:02.396058+00:00: R10 independent report audit and full handoff COMPLETE. All eight requests have exact trace coverage, all 59,872 main events and full context remain lossless, all five actual offline browser pages passed, and all four CPU phases closed normally. Complete R08, R09 and R10 Releases have verified remote asset hashes; R10 includes the standalone offline ZIP. Final fresh remote inventory review and supplementary Chinese-readable previews are being completed.

- 2026-09-08T22:39:09.603497+00:00: Final fresh GitHub API review verified 16 Releases and all 79 expected asset sizes/server SHA256 digests. All five supplementary Chinese-readable previews completed from unchanged accepted HTML with no external requests and normal browser closure. Normal stop requested for completed capture/health/progress watchdogs; a final remote snapshot follows.

- 2026-09-08T22:47:00.230012+00:00: Final completion records consolidated: R08/R09/R10 complete, 16 Releases / 79 asset SHA256 checks passed, all five readable previews complete. No additional machine time required. Watchdogs no longer running; health/progress wrapper exit codes 143 preserved without claiming normal exit. Final one-shot progress snapshot follows.

- 2026-09-08T22:49:01.399179+00:00: Final one-shot progress snapshot pushed and remote HEAD verified: 8ca7875c2c158d53ef5a6b69a68697957260217e. Snapshot manifest SHA256 8d2ce26119bb7a62790531229258778970b573eb992ce404c8a5d9bc8979f87b. All R08–R10 execution, independent audits, publications and recovery checkpoints complete; periodic processes stopped.
