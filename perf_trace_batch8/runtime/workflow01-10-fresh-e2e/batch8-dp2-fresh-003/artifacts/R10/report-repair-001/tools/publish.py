...
assets=[archive,ROOT/'acceptance/HIGH_LATENCY_PROCESS_HARDWARE_TIMELINE.html',ROOT/'acceptance/CONCURRENCY_UTILIZATION.html',ROOT/'inspection/high_first_group.png',ROOT/'inspection/dual_first.png',DIST/'FILE_MANIFEST.json']
