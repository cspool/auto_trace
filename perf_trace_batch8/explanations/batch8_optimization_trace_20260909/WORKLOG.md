...
- 2026-09-09T02:24:12.746933+00:00: 按用户反馈开始 v4：增加图 S 高度和 B1–B4 的物理纵向间距，保留矩形可读尺寸，使相邻 B 档的矩形在纵向分离；PDF 图 S 使用加高页面避免自动缩小后抵消间距调整。v3 发布回执已归档。

- 2026-09-09T02:27:16.542707+00:00: v4 图 S 画布由 32×18 英寸加高至 32×40 英寸；B 轴刻度物理间距为 290 pt（原约 91.1 pt，约 3.18 倍），信息矩形高度保持约 104.4 pt，相邻 B 档标注的最小纵向间隔为 46.4 pt。真实时间和 (time,B) 圆点坐标均通过核对。HTML 完整图和 PDF 第 5 页已视觉检查；该 PDF 页面为 420×560 mm，其余页沿用原排版。独立审计通过 16 个矩形分档间隔、8 个请求控件与 23,660 个 kernel 复核；17 页 PDF 全部非空、文字未越界。

- 2026-09-09T02:28:28.657862+00:00: v4 图表、HTML、PDF、生成代码和审计日志提交 `5452774f977be62d35f52a2b67435185d18bdee8` 已 push，远端 main 一致。v4 Release 五个资产全部核对大小和服务端 SHA256，ZIP 105 个成员逐项校验通过。发布日志、清单与回执继续提交到远程仓库。地址：https://github.com/cspool/auto_trace/releases/tag/perf-trace-batch8-dp2-scheduling-report-20260909-v4。
