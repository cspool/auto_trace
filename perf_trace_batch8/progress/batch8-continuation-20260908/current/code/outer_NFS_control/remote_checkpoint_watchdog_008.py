...
def snapshot():
 ...
 for p in sorted((CONTROL/'stage_tool_templates_002').rglob('*')):
  if p.suffix in ['.py','.js','.css','.json','.md']:copy(p,Path('code/prepared_not_executed_002')/p.relative_to(CONTROL/'stage_tool_templates_002'),'unfrozen_template_code')
