...
if os.environ.get('QWEN_DCU_R08_ENABLE_PROCESS_OVERLAY')=='1':
    ...
    require(os.environ.get('QWEN_DCU_R08_INDEPENDENT_COLLECTORS')=='1','independent native worker session mode')
    if os.environ.get('QWEN_DCU_R08_NATIVE_COLLECTOR_WORKER')=='1':
        for key in ['HIPPROF_INPUT_FILE','HIPPROF_TMP_OUTPUT_DIR']:
            require(bool(os.environ.get(key)),'live worker HIPProf exec environment missing: '+key)
